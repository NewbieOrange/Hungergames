...
public class TimerTask implements Runnable
{
    ...
    public TimerTask(Game g, int time)
    {
        ...
        this.id = Bukkit.getScheduler().scheduleSyncRepeatingTask(HG.plugin, this,
                30 * 20L, 30 * 20L);
    }
    ...
    public void run()
    {
        ...
        if (remainingtime == 30
                && HG.plugin.getConfig().getBoolean("settings.teleport-at-end"))
        {
        ...
        else
        {
            ...
            if (minutes != 0)
                game.msgAll(ChatColor.GREEN
                        + "The game is ending in "
                        + minutes
                        + (asd == 0 ? " minute(s)!" : " minute(s), and " + asd
                                + " seconds!"));
            else
                game.msgAll(ChatColor.GREEN + "The game is ending in "
