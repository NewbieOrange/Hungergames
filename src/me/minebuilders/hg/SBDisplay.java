...
public class SBDisplay
{
    ...
    public SBDisplay(Game g)
    {
        ...
        this.ob = board.registerNewObjective(ChatColor.GREEN
                + Config.l_SBDisplay_players_alive, "dummy");
        this.ob.setDisplaySlot(DisplaySlot.SIDEBAR);
        this.ob.setDisplayName(ChatColor.BLUE + "" + ChatColor.BOLD
                + Config.l_SBDisplay_title);
        this.g = g;
    }
    ...
    public void setAlive()
    {
        Score score = ob.getScore(Bukkit.getOfflinePlayer(ChatColor.GREEN
                + Config.l_SBDisplay_players_alive));
        score.setScore(g.getPlayers().size());
    }

    public void resetAlive()
    {
        board.resetScores(Bukkit.getOfflinePlayer(ChatColor.GREEN
                + Config.l_SBDisplay_players_alive));
        score.clear();
    }
